    ...
    public static void main(String[] args) throws StreamingQueryException {
        ...
        try {
            query = formattedDf.writeStream()
                    ...
                    .format("console")
                    .trigger(TrUnhandl@@ed exception type TimeoutExceptionJava(16777384)
DataStreamWriter<Row> org.apache.spark.sql.streaming.DataStreamWriter.trigger(Trigger trigger)igger.ProcessingTime("5 seconds"))  // Set a processing interval
                    .start();
        } catch (Exception e) {
